...
<title>Coffee Near Me - Menu With Price</title>
...
<meta name="description" content="All menus and locations of best Coffee restaurants including McDonald's, Starbucks Coffee, Caribou Coffee, and so on." />
<meta name="keywords" content="coffee near me, coffee beans, leisure, starbucks, americano" />
</head>
<body id="index-body">
...
<div class="content "  >
    <div class="main">
        <div class="bread-crumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
            ...
            <span itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                <a href="/donuts-near-me" itemprop="item"><i itemprop="name">Coffee Near Me</i></a>
                    <meta itemprop="position" content="2">
            </span> 
        </div>
        <div>
            <h1 style="color: blue;">Coffee Near Me</h1>
        </div>
<div class="brand-info brand classify-food-intro main1 " >
    <a href="#" class="brand-logo clf-logo"><img src="{{ asset('user/front_end/images/coffee-near-me.png')}}" alt="Coffee near me"></a>
        <p> 
        If asking who is a coffee addict, I bet a lot of people would raise their hands. Coffee is made from roasted coffee beans which are the seeds of the Coffea plants. The opinions on coffee's origin vary, however, it is well agreed that the ancestors of Oromo people are the first ones that found the energizing effect of coffee beans. Now, this effect is not the only reason why people like to drink coffee; the strong flavor and the bitter taste also attract so many customers. Or sometimes, people simply drink coffee to enjoy their leisure time because coffee can evoke a sense of emotional appeal.
        </p> 
</div>
</div>
