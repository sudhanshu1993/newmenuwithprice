...
<title>Chicken Near Me - Menu With Price</title>
...
<meta name="description" content="All menus and locations of best Chicken restaurants including Chick-fil-A, KFC, Bojangles', and so on." />
<meta name="keywords" content="chicken near me, nuggets, chicken wings, chicken legs, fried, chicken salad" /> 
</head>
<body id="index-body">
...
<div class="content">
    <div class="main">
        <div class="bread-crumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
            ...
            <span itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                <a href="/donuts-near-me" itemprop="item"><i itemprop="name">Chicken Near Me</i></a>
                    <meta itemprop="position" content="2">
            </span> 
        </div>
        <div>
            <h1 style="color: blue;">Chicken Near Me</h1>
        </div>
<div class="brand-info brand classify-food-intro main1 " >
    <a href="#" class="brand-logo clf-logo"><img src="{{ asset('user/front_end/images/chicken-near-me.png')}}" alt="Chicken near me"></a>
        <p> 
        Can you imagine Americans can eat a total of 160 million servings of chicken every day? Yes, it is true - Americans love chicken, and the same goes for people from all the other countries. Eating chicken has a long history which can date back to 600 BC. And by now, the ways of cooking chicken have been well developed, such as frying, roasting, stewing; and the dishes that are made of chicken are more varied, such as fried chicken wings, chicken salad, chicken soup. Almost all parts of chicken can be used in cooking, breast, wings, legs, feet and giblets. What's even better is that chicken is quite nutritious because it is rich in protein.
        </p> 
</div>
</div>
