...
<title>Best Restaurants Near Me and Locations in {{ $name}}</title>
...
<meta name="description" content="Best Restaurants near me in {{$name}} (US) for Lunch/ Dinner/ Breakfast. Top 50 All Cuisine/ Multi Cuisine Restaurants in {{$name}} State. " />
<meta name="keywords" content="Restaurants Near Me {{$name}}, Restaurants Locations Near Me in {{$name}}, Best Restaurants in {{$name}},  Best Restaurants Open Now in {{$name}}, Lunch Restaurants in {{$name}}, Dinner Near in {{$name}}" /> 
</head>
<body id="index-body">
